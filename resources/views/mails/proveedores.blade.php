                ...
                <tr>
                    <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td>
                                    <b>Mensaje de proveedores!</b>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 20px 0 30px 0;">
                                    El usuario {{$detalle['nombre']}} te ha enviado un mensaje del formulario de proveedores.
                                </td>
                            </tr>
                            ...
                            <tr><td style="padding: 5px 0 5px 0;" align="left"><b>Servicios o productos que ofrece</b>:  {{$detalle['servicios']}} </td></tr>
