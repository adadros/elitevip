                ...
                <tr>
                    <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td>
                                    <b>Contacto desde la página web!</b>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 20px 0 30px 0;">
                                    El usuario {{$detalle['nombre']}} te ha enviado un mensaje de contacto.
                                </td>
                            </tr>
                            ...
                            <tr><td style="padding: 5px 0 5px 0;" align="left"><b>Paises que le gustan</b>:  {{$detalle['paises']}} </td></tr>
                            <tr><td style="padding: 5px 0 5px 0;" align="left"><b>Hoteles que le gustan</b>:  {{$detalle['hoteles']}} </td></tr>
                            <tr><td style="padding: 5px 0 5px 0;" align="left"><b>Djs que le gustan</b>:  {{$detalle['djs']}} </td></tr>
                            <tr><td style="padding: 5px 0 5px 0;" align="left"><b>Tipo de musica que escucha</b>: {{$detalle['tipomusica']}} </td></tr>
                            <tr><td style="padding: 5px 0 5px 0;" align="left"><b>Sus hobbies</b>: {{$detalle['hobbie']}} </td></tr>
                            <tr><td style="padding: 5px 0 5px 0;" align="left"><b>Lo puedes encontrar por redes sociales como</b>: {{ $detalle['redes'] }} </td></tr>
