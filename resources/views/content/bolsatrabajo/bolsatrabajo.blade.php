...
@section('content')
    ...
    <div class="container mt-15" id="registro-form"  >
        <section>
            <h3 class="display1 fg-lightTaupe text-bold">Bolsa de trabajo</h3>

            <div class="descripcion fg-lightTaupe op-darkTaupe-hi py-3 px-3 mb-2">
                <h4>¿Quieres unirte a nuestro equipo?, Escríbenos a través de este formulario y nosotros te contactaremos.</h4>
            </div>

            <form method="post" action="{{route('bolsatrabajo_send')}}">
                {{@csrf_field()}}
                <div class="grid">
                    <div class="row">
